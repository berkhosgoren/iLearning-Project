...
namespace iLearning.Web.Controllers
{
    ...
    public class InventoriesController : Controller
    {
        ...
        public async Task <IActionResult> AutoSave(Guid id, InventoryUpsertVm vm)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return BadRequest(new { message = "validation_failed", errors });
            }
            ...
            if (!categoryExists)
            {
                return BadRequest(new
                {
                    ...
                    {
                        { nameof(vm.CategoryId), new [] { T["Inv.Err.InvalidCategory"].Value } }
                    }
                });
            }
